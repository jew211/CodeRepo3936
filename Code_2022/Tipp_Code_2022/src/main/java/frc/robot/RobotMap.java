...
public class RobotMap {
    ...
    public static final int popRelease = 1;
    public static final int leftLift1 = 2;
    public static final int leftLift2 = 3;
    public static final int rightLift1 = 4;
    public static final int rightLift2 = 5;
}
