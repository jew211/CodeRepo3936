...
public final class Constants {
    ...
    public static final int FRONT_LEFT_STEER_ENCODER_ID = 2;
    ...
    public static final int FRONT_RIGHT_STEER_ENCODER_ID = 3;
    ...
    public static final int BACK_LEFT_STEER_ENCODER_ID = 4;
    ...
    public static final int BACK_RIGHT_STEER_ENCODER_ID = 5;
