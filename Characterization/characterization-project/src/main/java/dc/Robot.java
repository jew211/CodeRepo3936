...
public class Robot extends TimedRobot {
  ...
  public VictorSP setupVictorSP(int port, Sides side, boolean inverted) {
  ...
  public void robotInit() {
    ...
    // create left motor
    VictorSP leftMotor = setupVictorSP(0, Sides.LEFT, false);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupVictorSP(1, Sides.FOLLOWER, false));
    ...
    VictorSP rightMotor = setupVictorSP(2, Sides.RIGHT, false);
    ArrayList<SpeedController> rightMotors = new ArrayList<SpeedController>();
    rightMotors.add(setupVictorSP(3, Sides.FOLLOWER, false));
